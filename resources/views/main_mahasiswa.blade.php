        ...
        <div class="container-nav">
            ...
            <div class="container-profile">
                ...
                <div class="info-profile">
                    ...
                    <hr>
                    <div class="jabatan">{{ $mhs->role }}</div>
                </div>
            </div>
        </div>
    </nav>
    <div class="konten">
        <aside>
            ...
            <div class="nav-side menu">
                ...
                <ul type='none'>
                    <li><i><img src="{{ asset('icon-profile.png') }}" class="logo" alt=""></i><a href="/profile/mhs">Profile</a></li>
                    {{-- <li><a href="">Ubah Profile</a></li> --}}
                    <li><i><img src="{{ asset('buku.png') }}" class="logo" alt=""></i><a href="/irs">Upload IRS</a></li>
                    <li><i><img src="{{ asset('buku1.png') }}" class="logo" alt=""></i><a href="/khs">Upload KHS</a></li>
                    <li><i><img src="{{ asset('pkl.png') }}" class="logo" alt=""></i><a href="/pkl">Upload PKL</a></li>
                    <li><i><img src="{{ asset('skripsi.png') }}" class="logo" alt=""></i><a href="/skripsi">Upload SKRIPSI</a></li>
                    <hr>
                </ul>
            </div>
            {{-- <div class="nav-side menu">
                <ul type='none'>
                    <li><a href="/irs">Upload IRS</a></li>
                    <li><a href="/khs">Upload KHS</a></li>
                    <li><a href="/pkl">Upload PKL</a></li>
                    <li><a href="/skripsi">Upload SKRIPSI</a></li>
                    <hr>
                </ul>
            </div> --}}
