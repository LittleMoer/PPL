...
.nav-side ul li:hover{
    color: black;
    background-color: rgb(42, 42, 213);
    ...
    <div class="konten">
        <aside>
            ...
            <div class="nav-side menu">
                ...
                <ul type='none'>
                    <li><i><img src="{{ asset('icon-profile.png') }}" class="logo" alt=""></i><a href="/profile/operator">Profile</a></li>
                    <li><i><img src="{{ asset('mahasiswa.png') }}" class="logo" alt=""></i><a href="/data/mhs">Data Mahasiswa</a></li>
                    <li><i><img src="{{ asset('buku.png') }}" class="logo" alt=""></i><a href="/entry">Entry MHS</a></li>
                    <hr>
                </ul>
            </div>
